...
else if (options.asImage || /image/.test(mimetype) && !options.asDocument)
mtype = 'image'

else if (options.asVideo || /video/.test(mimetype) && !options.asDocument)
mtype = 'video'

else if (/audio/.test(mimetype)) {
mtype = 'audio'

if (/mp3|mpeg/.test(mimetype))
mimetype = 'audio/mpeg'

if (/m4a|mp4/.test(mimetype))
mimetype = 'audio/mp4'
...
return await conn.sendMessage(jid, message, opt)
